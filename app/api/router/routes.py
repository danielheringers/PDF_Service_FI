...
from app.schemas.danfe.models import (
    Danfe,
)
from app.schemas.boleto.models import (
    Boleto,
)
from app.services.danfe.danfe_utils import (
    create_pdf_danfe,
)
from app.services.boletos.boleto_render import (
    create_pdf_boleto,
)
from app.core.security import (
    verify_headers,
)
from app.services.boletosV2.boleto_render import (
    create_pdf_teste,
)
...
async def create_boleto_pdf_endpoint(
    ...
    pdf_buffer = create_pdf_teste(data)
    pdf_buffer.seek(0)
    return StreamingResponse(
        pdf_buffer,
        media_type="application/pdf",
