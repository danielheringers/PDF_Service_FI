...
def create_pdf(data: dict):
    ...
    # Renderizar algo simples para testar
    pdf_canvas.setFont("Helvetica", 12)
    pdf_canvas.drawString(margin, height - margin - 20, "Testando renderização")
    ...
    # Log do tamanho do buffer para verificação
    print(f"Tamanho do PDF gerado: {buffer.getbuffer().nbytes} bytes")
